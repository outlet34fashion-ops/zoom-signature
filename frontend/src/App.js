    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Desktop Split Layout - only show on large screens */}
                            ...
                            <div className="flex justify-between items-start text-sm">
                              <div className="flex-1">
                                <div className="flex items-center space-x-2">
                                  <span className="font-medium text-gray-900">#{order.customer_number}</span>
                                  <span className="text-gray-600">{order.size}</span>
                                  <span className="text-gray-600">x{order.quantity}</span>
                                  <span className="font-semibold text-pink-600">{order.unit_price}€</span>
                                </div>
                                <div className="text-xs text-gray-500 mt-1">
                                  {formatGermanDateTime(order.timestamp)}
                                </div>
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="space-y-3">
                    ...
                    {/* Chat Messages */}
                    <div className="h-64 overflow-y-auto bg-gray-50 p-3 rounded-lg space-y-2">
                            ...
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <div className="font-medium text-sm">
                                  {formatMessage(msg.message)}
                                  {msg.emoji && <span className="ml-2">{msg.emoji}</span>}
                                </div>
