              ...
              {showCatalogManagement && (
                <div className="p-6 bg-white border-t">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <button
                      onClick={async () => {
                        console.log('🆕 ALTERNATIVE: Direct Category Creation clicked');
                        
                        const categoryName = prompt('Neue Kategorie erstellen:\n\nBitte geben Sie den Namen der neuen Hauptkategorie ein:');
                        
                        if (!categoryName || !categoryName.trim()) {
                          alert('❌ Kein Kategoriename eingegeben.');
                          return;
                        }
                        
                        const trimmedName = categoryName.trim();
                        console.log('🆕 Creating category directly:', trimmedName);
                        
                        try {
                          // Calculate next sort order
                          const nextSortOrder = Math.max(0, ...categories.map(cat => cat.sort_order || 0)) + 1;
                          ...
                          console.log('🆕 Sending direct API request with data:', categoryData);
                          ...
                          if (response.ok) {
                            ...
                            alert(`✅ Kategorie "${trimmedName}" erfolgreich erstellt!`);
                            ...
                            alert(`❌ Fehler beim Erstellen der Kategorie: ${errorData.detail || 'Unbekannter Fehler'}`);
                          }
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="text-left">
                          <div className="text-xl font-bold">Neue Kategorie</div>
                          <div className="text-sm opacity-90">Schnelle Kategorie-Erstellung</div>
                        </div>
                      </div>
                      <div className="text-2xl">
                        →
