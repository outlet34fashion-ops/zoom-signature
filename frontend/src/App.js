          ...
          <div className="relative z-10 min-h-screen flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center px-6">
              <div className="w-full max-w-md space-y-8">
                ...
                {/* CRITICAL: LIVEKIT DEMO - ALWAYS VISIBLE ON LANDING PAGE */}
                <div className="mb-6">
                    ...
                    {streamingActive && livekitToken && livekitUrl ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center text-white bg-gradient-to-br from-gray-900 to-gray-800">
                        <div className="text-center space-y-4">
                          ...
                          <h3 className="text-lg font-bold">Live Streaming Demo</h3>
                          <p className="text-gray-300 text-xs">Testen Sie jetzt die LiveKit-Funktionalität!</p>
                          
                          <div className="flex flex-col gap-2">
                            <Button 
                              onClick={async () => {
                                try {
                                  console.log('🎥 LANDING PAGE DEMO: Customer joining...');
                                  
                                  const roomName = `landing-customer-${Date.now()}`;
                                  await livekitService.createRoom(roomName, 100);
                                  ...
                                  console.log('✅ Landing page customer demo started successfully');
                                } catch (error) {
                                  console.error('❌ Landing page customer demo failed:', error);
                            ...
                            <Button 
                              onClick={async () => {
                                try {
                                  console.log('🎥 LANDING PAGE DEMO: Admin streaming...');
                                  
                                  const roomName = `landing-admin-${Date.now()}`;
                                  await livekitService.createRoom(roomName, 100);
                                  ...
                                  console.log('✅ Landing page admin demo started successfully');
                                } catch (error) {
                                  console.error('❌ Landing page admin demo failed:', error);
                                  alert('❌ Demo fehlgeschlagen: ' + error.message);
                                }
                              }}
