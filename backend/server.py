...
class CatalogProduct(BaseModel):
    ...
    category_id: str  # For backward compatibility - will be main_category_id
    price: float
    sizes: List[str] = []
...
async def register_customer(customer: CustomerCreate):
    ...
    try:
        ...
        created_customer = {
            ...
            "member_since": customer_obj.member_since.isoformat() if customer_obj.member_since else None,
...
# Batch update categories sort order
