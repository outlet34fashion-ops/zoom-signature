...
"""
    ...
    def test_zebra_printer_endpoints(self):
        ...
        try:
            print("  🔍 Test 1: Testing printer status endpoint...")
        ...
        try:
            print("  📄 Test 2: Testing ZPL preview generation...")
        ...
        try:
            print("  🧪 Test 3: Testing test label printing...")
        ...
        try:
            print("  📦 Test 4: Testing order label printing...")
        ...
        try:
            print("  📏 Test 5: Testing ZPL format validation for 40x25mm labels...")
        ...
        try:
            print("  🔄 Test 6: Testing automatic label printing integration with orders...")
            ...
            if success:
                ...
                # Check if label printing fields are present (added by automatic printing)
                has_label_fields = hasattr(order_data, 'label_printed') or 'label_printed' in str(order_data)
        ...
        try:
            print("  ⚠️  Test 7: Testing error handling for printer offline scenarios...")
        ...
        # Calculate Zebra printer test results
        zebra_tests = [r for r in self.test_results if 'ZEBRA' in r['name']]
        zebra_tests_recent = zebra_tests[-7:]  # Get the last 7 Zebra tests
        zebra_success_count = sum(1 for test in zebra_tests_recent if test['success'])
        
        print(f"  📊 Zebra Printer Tests: {zebra_success_count}/{len(zebra_tests_recent)} passed")
        print(f"  🎯 CRITICAL ZEBRA FUNCTIONALITY:")
        ...
        return zebra_success_count >= 5  # At least 5/7 tests should pass for critical functionality
